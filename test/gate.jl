...
@testset "inv" begin
    ...
    Qanuk.get_operator(gate::UnknownGate) = DenseOperator([1 2; 3 4])
    ...
    Qanuk.get_operator(gate::UnknownHermitianGate) = DenseOperator([1 im; -im 1])
...
@testset "move_gate" begin
    ...
    @test is_gate_type(untouched_rx_gate, Qanuk.RotationX)
    @test get_gate_type(untouched_rx_gate) == Qanuk.RotationX
    ...
    moved_rx_gate = move_gate(rx_gate, qubit_mapping)
    @test is_gate_type(moved_rx_gate, Qanuk.RotationX)
    @test get_gate_type(moved_rx_gate) == Qanuk.RotationX
    ...
    @test is_gate_type(moved_twice_rx, Qanuk.RotationX)
    @test get_gate_type(moved_twice_rx) == Qanuk.RotationX
    ...
    @test is_gate_type(inverse_moved_gate, Qanuk.RotationX)
    ...
    @test is_gate_type(moved_toffoli_gate, Qanuk.Toffoli)
