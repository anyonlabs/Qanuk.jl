...
@testset "DiagonalOperator: 2 targets" begin
    ...
    Qanuk.apply_operator!(ψ, diag_op,[target_qubit_1,target_qubit_2])
...
@testset "DiagonalOperator: 3 targets" begin
    ...
    Qanuk.apply_operator!(ψ,diag_op,connected_qubits)
    ...
    @test_throws InexactError Qanuk.apply_operator!(ψ,diag_op,connected_qubits)
