...
no_throttle=()->Qanuk.default_status_request_throttle(0)
...
@testset "requestor" begin
    struct NonImplementedRequestor<:Qanuk.Requestor end
    ...
    response=get_request(
        requestor,
        host*"/"*Qanuk.path_circuits*"/"*circuitID,
        access_token
    )
    ...
    @test_throws NotImplementedError get_request(
        requestor,
        host*"/"*string(Qanuk.path_circuits,"wrong_ending"),
        access_token
    )
    ...
    response=get_request(
        requestor,
        host*"/"*Qanuk.path_circuits*"/"*circuitID*"/"*Qanuk.path_results,
        access_token
    )
    ...
    @test_throws NotImplementedError get_request(
        requestor,
        host*"/"*Qanuk.path_circuits*"/"*circuitID*"/"*string(Qanuk.path_results,"wrong_ending"),
        access_token
    )
...
@testset "AbstractQPU" begin
    struct NonExistentQPU<:Qanuk.AbstractQPU end
