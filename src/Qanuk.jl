# This file is part of Qanuk package. License is Apache 2: https://github.com/anyonlabs/Qanuk.jl/blob/main/LICENSE  
"""
Qanuk is an open source library for quantum computing using Julia.
Qanuks allows one to easily design quantum circuits, experiments and applications and run them on real quantum computers and/or classical simulators. 
"""
